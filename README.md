...
2. Ensure you have a DocuSign Organization with Admin capabilities. The DocuSign Admin API is available to accounts with Organization Administration enabled, typically requiring an Enterprise plan or higher.

### Step 2: Generate an API Access Token

1. Log in to your [DocuSign Developer Account](https://developers.docusign.com/) and access the Apps and Keys page.

2. On the left navigation menu, select Settings, then click Apps and Keys.

3. Under My Apps, click Add App and Integration Key to create a new application, or select an existing app.
...
6. To generate an access token for testing, navigate to the [API Explorer](https://developers.docusign.com/tools/api-explorer/) or use the OAuth flow with your Integration Key and Secret Key to obtain an access token.
