...
2. Note that the DocuSign Admin API requires an Organization-level account with Admin privileges. This functionality is available to customers on DocuSign Business Pro, Enterprise Pro, or higher plans with DocuSign Admin enabled.
...
6. For quick testing, you can generate a temporary access token by navigating to your app settings and clicking **Generate Access Token** under the Actions menu.
